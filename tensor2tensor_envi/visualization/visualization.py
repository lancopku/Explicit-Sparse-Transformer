...
class AttentionVisualizer(object):
  ...
  def __init__(
      self, hparams_set, hparamss, model_name, data_dir, problem_name, beam_size=1):
    inputs, targets, samples, att_mats = build_model(
        hparams_set,hparamss, model_name, data_dir, problem_name, beam_size=beam_size)
...
def build_model(hparams_set, hparamss,model_name, data_dir, problem_name, beam_size=1):
  ...
  hparams = trainer_lib.create_hparams(
      hparams_set, hparamss, data_dir=data_dir, problem_name=problem_name)

      ...
      with tf.variable_scope(layer_name):
        with tf.variable_scope("self_attention"):
          y = common_attention.multihead_attention(
              ...
              hparams=hparams,
              self_attenion_type='decoder_self_attention',)
        ...
        if encoder_output is not None:
          with tf.variable_scope("encdec_attention"):
            y = common_attention.multihead_attention(
                ...
                vars_3d=hparams.get("attention_variables_3d"),
                hparams=hparams,
                self_attenion_type='decoder_context_attention')
            x = common_layers.layer_postprocess(x, y, hparams)
...
def transformer_base_v1():
  ...
  hparams.add_hparam('d', 0)
  hparams.add_hparam('lb', 0)
  hparams.add_hparam('before_softmax', False)
  hparams.add_hparam('before_padding', False)
  hparams.add_hparam('softmax_again', False)
  hparams.add_hparam('selected_topk_attention_type', 'all')
